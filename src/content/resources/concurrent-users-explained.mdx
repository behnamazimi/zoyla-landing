...
This is simplified. Real traffic is bursty. You need headroom. But it's a starting point.
...
Concurrent users is a fuzzy term. Requests per second is concrete. When planning capacity, translate user counts into request rates.
