...
**Timeouts** — the server didn't respond in time. Could mean it's overloaded. Could mean a request got stuck. Could mean network issues.
...
**Errors spike suddenly at a threshold** — you hit a hard limit. Connection pool exhausted, thread pool full, rate limiter kicked in.
