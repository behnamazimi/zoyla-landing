...
If your system handles 1000 RPS and each user makes one request per second, you can support 1000 [concurrent users](/resources/concurrent-users-explained). If users make 10 requests per second each, you can support 100 users.
...
Without the RPS number, you're guessing. With it, you can plan. The [capacity planning basics](/resources/capacity-planning-basics) guide shows how to turn these numbers into infrastructure decisions.
