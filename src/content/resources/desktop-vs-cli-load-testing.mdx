...
If you're already using k6 in your CI/CD, keep using it. The scriptability is the point. For more on CI/CD integration, see [continuous performance testing](/resources/continuous-performance-testing).
...
The goal is getting useful performance data. The specific tool matters less than actually running the tests. For a minimal starting point, see [simple load testing setup](/resources/simple-load-testing-setup).
