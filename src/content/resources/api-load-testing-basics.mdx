...
Most APIs require some form of authentication. Tokens, API keys, session cookies. Your load test needs to handle this correctly or you're just testing your auth rejection flow a thousand times.
...
Think about what real traffic looks like. If users typically send 2KB payloads but occasionally send 50KB, your test should reflect that distribution.
...
That's API load testing. Same principles as any load testing, just with attention to the details that matter for APIs specifically.
