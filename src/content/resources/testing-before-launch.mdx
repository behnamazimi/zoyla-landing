...
Test at your expected peak load. Then test at 2x that. You want to know you have headroom, not just that you'll barely survive.
...
Document results at each stage. You're building evidence that you're ready.
...
Have a rollback plan. If things go badly, you want to be able to reduce load quickly.
