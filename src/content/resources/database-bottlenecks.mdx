...
During your load test, watch database metrics alongside application metrics. The [monitoring during load tests](/resources/monitoring-during-load-tests) guide covers what to look for.
...
**[Connection pool exhaustion](/resources/connection-pooling-performance)** — more requests than connections. Requests wait. Latency explodes.
