...
The tradeoff is you're limited to the load your machine can generate. For testing APIs during development, that's usually plenty. For simulating massive distributed attacks, you'd need something else.
...
Think about what you're testing. Internal or public? Sensitive data or not? How much load do you actually need?
