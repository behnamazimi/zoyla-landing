...
While latency asks "how long," throughput asks "how many." [Requests per second](/resources/requests-per-second-explained). Transactions per minute. Whatever unit makes sense for your system.
...
Simple math, profound implications. If your latency is 100ms and you want 1000 requests per second, you need 100 [concurrent connections](/resources/concurrent-users-explained). If latency doubles to 200ms, you now need 200 concurrent connections to maintain the same throughput. And if your system can only handle 150 connections? Your throughput drops. You can't hit 1000 RPS anymore.
...
This is why [capacity planning](/resources/capacity-planning-basics) matters. You can't just look at throughput in isolation.
