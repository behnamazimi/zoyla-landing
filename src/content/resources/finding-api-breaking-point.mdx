...
Stress testing is about intentionally pushing past normal limits to discover where things fail. Not if. Where. The [stress testing vs load testing](/resources/stress-testing-vs-load-testing) comparison explains when each approach makes sense.

## The process

Start with a baseline. Run a load test at your expected traffic level. Document the results — throughput, latency, error rate. This is your "normal." The [performance baselines](/resources/performance-baselines) guide covers how to establish and track these.
...
Check your server metrics during the test. CPU maxed out? That's your limit. Memory exhausted? Different problem. Database connections at maximum? There's your bottleneck. The [monitoring during load tests](/resources/monitoring-during-load-tests) guide covers what to watch.
...
**Set capacity limits** — if you break at 500 RPS, don't promise 600. Build in margin. The [capacity planning basics](/resources/capacity-planning-basics) guide shows how to translate these numbers into infrastructure decisions.
